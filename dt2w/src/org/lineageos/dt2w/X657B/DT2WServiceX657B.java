package org.lineageos.dt2w.X657B;
...
public class DT2WServiceX657B extends Service {
    private static final String TAG = "DT2WServiceX657B";
    ...
    private class CustomSettingsObserver extends ContentObserver {
        ...
        void update() {
            ...
            SystemProperties.set("persist.sys.X657B.dt2w", dt2wEnabled ? "1" : "0");
        }
